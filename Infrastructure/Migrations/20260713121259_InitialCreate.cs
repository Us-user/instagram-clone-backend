    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowingRelationShips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FollowingRelationShips_AspNetUsers_FollowingUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSearchHistories_AspNetUsers_SearchedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PostId = table.Column<int>(type: "integer", nullable: false),
                    ImageName = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoryViews_AspNetUsers_ViewUserId",
                        column: x => x.ViewUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowingRelationShips_UserId_FollowingUserId",
                table: "FollowingRelationShips",
                columns: new[] { "UserId", "FollowingUserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoryViews_StoryId_ViewUserId",
                table: "StoryViews",
                columns: new[] { "StoryId", "ViewUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StoryViews_ViewUserId",
                table: "StoryViews",
                column: "ViewUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSearchHistories_SearchedUserId",
