...
## 📍 Текущий статус
- **Активная фаза:** Phase 23 — Активные сеансы + Refresh-токены (access+refresh) — **завершена**: сборка 🟢, миграция применена, **живой smoke на PostgreSQL пройден 27/27** (одноразовый кластер PG17). Phase 22 (харденинг/документация) закрыта.
